...
public final class SimpleTerrainShader {
    ...
    /*
     * Object visibility follows the same fixed-point camera transform and integer
     * 512/z projection used by Mesh.renderFaces(). ObjectMeshBuilder now also uses
     * RS's fixed-point orientation transform, so the geometry supplied here matches
     * the software renderer before the winding test rather than an approximate
